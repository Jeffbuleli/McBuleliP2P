...
## Intérêt de participer (angle créa)

- Se former concrètement au **code avec IA** (pas du buzz : outils utilisés en atelier)
- **Se constituer en équipe** et livrer un prototype sous contrainte temps
- Pitcher devant un **jury exigeant** (crédibilité, feedback, réseau)
- Visibilité + **prix** + certificat / storytelling pour le portfolio

## Charte graphique (Hackathon surface)
