#!/usr/bin/env bash
# One-shot / scheduled prod send of partner budget pitch emails.
# Target: 5 Aug 2026 09:00 Africa/Kinshasa (= 08:00 UTC).
#
# Usage:
#   bash ops/vps/send-partner-budget-pitch-once.sh
#   bash ops/vps/send-partner-budget-pitch-once.sh --force
#
...
STAMP="${PARTNER_BUDGET_PITCH_STAMP:-$LOG_DIR/partner-budget-pitch-2026-08-05.done}"
FORCE=0
...
echo "==> $(date -u +%Y-%m-%dT%H:%M:%SZ) partner-budget-pitch send"
