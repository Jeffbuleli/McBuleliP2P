              ...
              >
                ...
                {s.isLiveNow ? (
                  <Link
                    ...
                    className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#305f33] px-3 py-2.5 text-sm font-extrabold text-white"
                  >
      ...
      {detail.replays.length > 0 ? (
        <section>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold">{t("academy_replays")}</h2>
          </div>
          <ul className="mt-2 space-y-2">
              ...
              <li key={s.id} className="rounded-xl border bg-white p-3">
                ...
                {s.replayUrl ? (
                  <a
                    ...
                    className="mt-2 inline-flex w-full justify-center rounded-lg border px-3 py-2 text-sm font-bold text-[color:var(--fd-primary)]"
                  >
