...
export const en = {
  ...
  support_subtitle: "Chat with McBuleli agents — messages, @mentions, and read receipts.",
  support_agent_online: "Agents can join anytime",
  support_placeholder: "Write a message… Use **bold**, *italic*, __underline__, links, @mentions",
  support_send: "Send",
  ...
  support_mention_hint: "@ to mention an agent",
  support_you: "You",
...
export const fr: Messages = {
  ...
  support_title: "Support",
  support_subtitle:
    "Échangez avec les agents McBuleli — messages, @mentions et accusés de lecture.",
  support_agent_online: "Un agent peut rejoindre à tout moment",
  support_placeholder:
    "Votre message… **gras**, *italique*, __souligné__, liens, @mentions",
  ...
  support_unread: "Non lu",
  support_attach_image: "Image",
  support_mention_hint: "@ pour mentionner un agent",
  support_you: "Vous",
