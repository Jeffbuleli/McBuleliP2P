...
export const en = {
  ...
  bots_smart_exit_mode: "Smart exit (reversal)",
  bots_smart_exit_hint:
    "While a position is open, each cron run reads the market ({tf}) and closes if the signal flips against your trade and profit ≥ minimum.",
  bots_smart_exit_reversal_score: "Reversal strength (min. score)",
  bots_smart_exit_min_profit: "Min. profit before smart exit (%)",
...
export const fr: Messages = {
  ...
  bots_smart_exit_mode: "Sortie intelligente (retournement)",
  bots_smart_exit_hint:
    "Position ouverte : à chaque cron, lecture du marché ({tf}) et clôture si le signal s’inverse contre votre trade et profit ≥ minimum.",
  bots_smart_exit_reversal_score: "Force du retournement (score min.)",
  bots_smart_exit_min_profit: "Profit min. avant sortie smart (%)",
