...
export const en = {
  ...
  p2p_home_hint:
    "McBuleli locks crypto in escrow. You pay each other off-platform (Airtel, Orange, bank…) — only payment proof between you counts.",
  ...
  p2p_trade_min_quote: "Min. {amount} {quote} (≈ {minCrypto} {asset})",
  p2p_quote_wallet_insufficient: "Not enough {quote} in your McBuleli wallet.",
  p2p_payment_methods_profile_hint:
    "Account name and number are managed in Profile → My payment methods.",
  p2p_reserve_label: "Reserve (crypto) for this ad",
  p2p_reserve_hint: "This amount is locked in escrow and decreases with each order.",
  p2p_mark_paid_payer: "I have paid (off-platform)",
  p2p_order_release_fiat: "Release crypto (fiat received)",
  p2p_section_payment_fiat: "Pay seller (off-platform)",
  p2p_section_payment_wallet: "On-platform payment",
  p2p_trust_release_warning_fiat:
    "Only release after you verified fiat in your MoMo/bank account.",
  ...
  p2p_fiat_quote_escrow_note:
    "Quote currency is what the price is shown in. For USD/CDF, payment stays off-platform. For USDT/PI quotes, payment is on-platform. Escrow stays in the ad asset (USDT or PI).",
  p2p_crypto_quote_hint:
    "Crypto quote selected. Payment will happen inside McBuleli (USDT/PI wallet), then escrow releases immediately.",
  p2p_crypto_quote_take_hint:
    "This ad uses {quote} as the quote. When you confirm, you pay in {quote} from your McBuleli wallet and receive the escrowed asset instantly.",
  ...
  p2p_price_per_unit: "Price (quote per 1 unit of crypto)",
  p2p_min_fiat: "Minimum quote amount",
  p2p_max_fiat: "Maximum quote amount",
...
export const fr: Messages = {
  ...
  p2p_home_hint:
    "McBuleli bloque la crypto en séquestre. Vous vous payez hors plateforme (Airtel, Orange, banque…) — seules vos preuves de paiement comptent.",
  ...
  p2p_payment_methods_profile_hint:
    "Nom et numéro de compte : Profil → Mes moyens de paiement.",
  p2p_reserve_label: "Réserve (crypto) pour cette annonce",
  p2p_reserve_hint: "Montant bloqué en séquestre, diminue à chaque ordre.",
  p2p_mark_paid_payer: "J’ai payé (hors plateforme)",
  p2p_order_release_fiat: "Libérer la crypto (fiat reçu)",
  p2p_section_payment_fiat: "Payer le vendeur (hors plateforme)",
  p2p_section_payment_wallet: "Paiement sur plateforme",
  p2p_trust_release_warning_fiat:
    "Ne libérez qu’après avoir vérifié le fiat sur votre compte MoMo/banque.",
  ...
  p2p_fiat_quote_escrow_note:
    "La devise de cotation sert à afficher le prix. En USD/CDF, le paiement reste hors application. En cotation USDT/PI, le paiement est dans McBuleli. Le séquestre reste dans l’actif de l’annonce (USDT ou PI).",
  p2p_crypto_quote_hint:
    "Cotation crypto sélectionnée. Le paiement se fait dans McBuleli (wallet USDT/PI), puis le séquestre se libère immédiatement.",
  p2p_crypto_quote_take_hint:
    "Cette annonce utilise {quote} comme cotation. À la confirmation, tu paies en {quote} depuis ton wallet McBuleli et tu reçois l’actif sous séquestre immédiatement.",
  p2p_quote_fiat_not_allowed:
  ...
  p2p_price_per_unit: "Prix (cotation pour 1 unité de crypto)",
  p2p_min_fiat: "Montant de cotation minimum",
  p2p_max_fiat: "Montant de cotation maximum",
