...
export const en = {
  ...
  bots_plan_dca_desc: "Scheduled spot buys (DCA).",
  bots_plan_grid_desc: "Limit buys in a price range.",
  bots_plan_futures_desc: "USDⓈ-M with leverage, SL/TP.",
...
export const fr: Messages = {
  ...
  bots_plan_dca_desc: "Achats spot programmés (DCA).",
  bots_plan_grid_desc: "Limits d’achat dans une fourchette.",
  bots_plan_futures_desc: "USDⓈ-M avec levier, SL/TP.",
