...
export function buildVisionPartnerEmail(profile: VisionPartnerProfile): VisionPartnerEmailCopy {
  ...
  const text = [
    ...
    "",
    "Nous organisons le McBuleli Hackathon à Kinshasa : 1 journée (28 Août 2026, 08h00–17h00) de bootcamp Vibe Coding, build produit et Demo Day au Silikin Village.",
    "",
    HACKATHON_PROGRAMME_HEADER_FR,
    ...hackathonScheduleLinesFr(),
