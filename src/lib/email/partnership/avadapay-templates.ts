...
export type AvadapayTemplateId =
  | "avadapay_initial_fr"
  | "avadapay_initial_en"
...
const TEMPLATES: Record<AvadapayTemplateId, PartnershipTemplate> = {
...
export function getAvadapayTemplate(id: AvadapayTemplateId): PartnershipTemplate {
  const t = TEMPLATES[id];
  if (!t) throw new Error(`Unknown AvadaPay template: ${id}`);
  return t;
}

export function listAvadapayTemplateIds(): AvadapayTemplateId[] {
  return Object.keys(TEMPLATES) as AvadapayTemplateId[];
}

/** @deprecated import from partnership-registry */
export type PartnershipTemplateId = AvadapayTemplateId;
/** @deprecated import from partnership-registry */
export { PARTNERSHIP_PLACEHOLDERS } from "@/lib/email/partnership/partnership-placeholders";
/** @deprecated import from partnership-registry */
export function getPartnershipTemplate(id: AvadapayTemplateId): PartnershipTemplate {
  return getAvadapayTemplate(id);
}
/** @deprecated import from partnership-registry */
export function listPartnershipTemplateIds(): AvadapayTemplateId[] {
  return listAvadapayTemplateIds();
}
