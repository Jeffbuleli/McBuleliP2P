...
export function pageContextHint(
  ...
  const hints: Record<string, Record<"en" | "fr" | "sw", string>> = {
    ...
    hackathon: {
      en: "User is on a Hackathon page. Facts: Silikin Village (63 Ave Colonel Mondjiba, Kinshasa); confirmed 28 August 2026, 08:00–17:00 (one full day); single 100 USD pack; email confirm then seat hold with NO auto-expiry + 24h pay reminders; MoMo Orange/M-Pesa/Airtel (243…); QR ticket at /hackathon/pass/[code]; ambassador promo at /hackathon/ambassadeur; partners/sponsors forms on /hackathon. Do NOT say dates are TBA or that holds expire in 72h.",
      fr: "L'utilisateur est sur une page Hackathon. Faits : Silikin Village (63 Ave Colonel Mondjiba, Kinshasa) ; date confirmée 28 août 2026, 08h00–17h00 (une journée) ; pack unique 100 USD ; confirmation e-mail puis place sans expiration auto + rappels paiement 24 h ; MoMo Orange/M-Pesa/Airtel (243…) ; ticket QR sur /hackathon/pass/[code] ; ambassadeur sur /hackathon/ambassadeur ; formulaires partenaire/sponsor sur /hackathon. Ne dites PAS que les dates sont « bientôt » ni qu'une place expire en 72 h.",
