...
export const HACKATHON_PHASES: HackathonPhase[] = [
  ...
  },
  {
    ...
    bodyFr: "Créer / rejoindre une équipe (rôles uniques, max 5), choix parmi 3 défis, règlement.",
    bodyEn: "Create / join a team (unique roles, max 5), pick among 3 challenges, accept rules.",
