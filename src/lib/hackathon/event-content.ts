  ...
  return [
    {
      ...
      slots: [
        ...
        { time: "08h50 - 09h10", activityFr: "Ouverture Mme Patty B. puis McBuleli IA (qui sommes-nous, technologies, règles)", activityEn: "Opening by Mrs Patty B. then McBuleli IA (who we are, stack, rules)", icon: "mic" },
        { time: "09h10 - 10h20", activityFr: "Vitrine partenaires modérée par McBuleli IA (10 min / org)", activityEn: "Partner showcase moderated by McBuleli IA (10 min / org)", icon: "partners" },
        ...
        { time: "12h45 - 15h30", activityFr: "Build intensif + mentorat partenaires (terrain) · tempo McBuleli IA", activityEn: "Intensive build + partner mentoring (floor) · McBuleli IA tempo", icon: "build" },
