  ...
  return [
    {
      ...
      slots: [
        ...
        { time: "08h50 - 09h10", activityFr: "Ouverture McBuleli, défis et règles", activityEn: "McBuleli opening, challenges & rules", icon: "mic" },
        { time: "09h10 - 10h20", activityFr: "Vitrine partenaires (10 min / org)", activityEn: "Partner showcase (10 min / org)", icon: "partners" },
        { time: "10h20 - 10h30", activityFr: "Pause / photo partenaires", activityEn: "Break / partner photo", icon: "coffee" },
        { time: "10h30 - 11h30", activityFr: "Bootcamp Vibe Coding (1 h)", activityEn: "Vibe Coding bootcamp (1 h)", icon: "code" },
        { time: "11h30 - 12h00", activityFr: "Formation des équipes et choix des défis", activityEn: "Team formation & challenge pick", icon: "team" },
        { time: "12h00 - 12h45", activityFr: "Pause déjeuner & networking", activityEn: "Lunch break & networking", icon: "network" },
        { time: "12h45 - 15h30", activityFr: "Build intensif + mentorat partenaires", activityEn: "Intensive build + partner mentoring", icon: "build" },
        ...
        { time: "16h40 - 17h00", activityFr: "Clôture et suite éventuelle Jour 2", activityEn: "Close & optional Day 2 outlook", icon: "clock" },
      ],
    },
    {
      day: 2,
