  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "MBP is a community engagement program. It complements staking and McB; it does not replace them. Holding McB does not automatically grant Builder status.",
        },
        {
          type: "ul",
          items: [
            "Levels (named): Bronze · Silver · Gold · Diamond · Platinum - exact thresholds TBD",
            ...
            "Roles: Builder (badge) ≠ Ambassador (application) ≠ Official Representative (appointed by McBuleli)",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Is there an ICO? No.",
            "What is the Builders Program? A draft community track (Build. Grow. Belong.) - thresholds and perks TBD.",
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "Le MBP est un programme d’engagement communautaire. Il complète le staking et le McB ; il ne les remplace pas. Détenir du McB n’accorde pas automatiquement le statut Builder.",
        },
        {
          type: "ul",
          items: [
            "Niveaux (noms) : Bronze · Silver · Gold · Diamond · Platinum - seuils exacts à définir",
            ...
            "Rôles : Builder (badge) ≠ Ambassadeur (candidature) ≠ Représentant officiel (nommé par McBuleli)",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Qu’est-ce que le Builders Program ? Une piste communautaire en draft (Build. Grow. Belong.) - seuils et avantages à définir.",
