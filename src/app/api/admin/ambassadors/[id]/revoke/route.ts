...
import { revokeAmbassadorMandate } from "@/lib/community/ambassador-service";
...
export async function POST(
  ...
  const result = await revokeAmbassadorMandate({
    applicationId: id,
  ...
  await writePlatformAdminAudit({
    ...
    action: PlatformAdminAuditAction.AMBASSADOR_REVOKE,
