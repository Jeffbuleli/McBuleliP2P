...
const DESCRIPTION =
  "Hackathon et bootcamp IA organisés par McBuleli à Kinshasa. Vibe Coding, 4 défis (FinTech, AgroTech, Santé & éducation, GovTech & cybersécurité), pitch jury, incubation. Inscrivez-vous ou devenez partenaire.";
...
function eventJsonLd(data: NonNullable<Awaited<ReturnType<typeof getFeaturedHackathon>>>) {
  ...
  return {
    ...
    offers: [
      {
        "@type": "Offer",
        name: "McBuleli Hackathon - 1 Jour",
  ...
  return (
    <>
      ...
      {data ? (
        <>
          {usedDemo ? (
            <div className="border-b border-amber-500/30 bg-amber-500/10 px-4 py-2 text-center text-xs text-[color:var(--hk-warn-text,#92400e)]">
              <HackathonLocaleText
