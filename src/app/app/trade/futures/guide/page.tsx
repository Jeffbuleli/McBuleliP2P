...
export default async function FuturesGuidePage() {
  ...
  const deepSections = [
    ...
    { title: d.trade_futures_deep_funding_title, body: d.trade_futures_deep_funding_body },
    { title: d.trade_futures_deep_bottom_title, body: d.trade_futures_deep_bottom_body },
  ];
