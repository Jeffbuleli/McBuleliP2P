...
- Monthly earn cap: **4,000 BP / user** (anti-farming; `REWARD_MONTHLY_EARN_CAP`); **one-shot grants skip cap on reconcile/backfill**
...
Full earn/spend matrix, supply proposal, and phase A/B/C plan: [`mcb-tokenomics-reference.md`](./mcb-tokenomics-reference.md).  
Public Constitution Lite: [`mcbuleli-constitution-outline.md`](./mcbuleli-constitution-outline.md) → `https://mcbuleli.org/whitepaper`.
