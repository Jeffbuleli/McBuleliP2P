# Silikin Village - reservation salle Hackathon

- **Reception** : reception_skv@texaf-rdc.com · +243 810 002 716
...
npx tsx scripts/send-silikin-venue-email.ts --to reception_skv@texaf-rdc.com --send
```
