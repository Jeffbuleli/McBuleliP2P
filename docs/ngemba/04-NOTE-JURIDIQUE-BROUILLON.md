...
NGEMBA est une **plateforme d’orientation et d’alerte citoyenne**.  
Elle **ne remplace pas** la police, les pompiers, les services médicaux ni la justice.

## 2. Responsabilités (à clarifier)
...
- [ ] Avis avocat RDC (responsabilité plateforme)
- [ ] Politique de confidentialité publiée
- [ ] CGU citoyen + charte ONG
- [ ] Accord écrit ONG pilote (SLA, horaires, escalade)

*Ne pas présenter ce document comme un avis juridique.*
