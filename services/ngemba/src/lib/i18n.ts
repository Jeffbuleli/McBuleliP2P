...
const baseFr: Copy = {
  ...
  sosComposeHint: "Danger — besoin d'aide maintenant. Ngemba IA oriente, un humain répond.",
...
export const messages: Record<Locale, Copy> = {
  ...
  en: {
    ...
    sosComposeHint: "Danger — need help now. Ngemba IA orients, a human responds.",
  ...
  ln: {
    ...
    sosComposeHint: "Mpasi — lisungi sikoyo. Ngemba IA azongisa, moto akoyeba.",
  ...
  sw: {
    ...
    sosComposeHint: "Hatari — msaada sasa. Ngemba IA inaongoza, binadamu anajibu.",
