...
const baseFr: Copy = {
  ...
  sos: "SOS",
  sosHint: "Danger",
  line: "Ngemba IA oriente - un humain répond",
  powered: "Ngemba IA",
  ...
  orientationTitle: "Orientation Ngemba IA",
  polishUnavailable: "Clarification indisponible - votre texte est envoyé tel quel.",
  mediaOnlyAlert: "Alerte multimédia (audio ou photo) - Ngemba IA oriente, un humain lit le dossier.",
  back: "Retour",
  ...
  voice: "Audio",
  voiceRecord: "Parler",
  voiceListening: "Enregistrement...",
  voiceImport: "Importer",
  voiceChange: "Changer",
  voiceTooLarge: "Audio trop volumineux (max 10 Mo)",
  voiceUnsupported: "Audio non disponible sur cet appareil",
  myAlerts: "Mes alertes",
  addMedia: "Photo",
  mediaHint: "4 photos · audio 10 Mo",
...
export const messages: Record<Locale, Copy> = {
  ...
  en: {
    ...
    sos: "SOS",
    sosHint: "Danger",
    line: "Ngemba IA orients - a human responds",
    powered: "Ngemba IA",
    aiListening: "Ngemba IA",
    polish: "Clarify",
    polishing: "Clarification...",
    ...
    installLater: "Later",
    orientationTitle: "Ngemba IA orientation",
    polishUnavailable: "Clarification unavailable - your text is sent as is.",
    mediaOnlyAlert: "Media alert (audio or photo) - Ngemba IA orients, a human reviews the case.",
    back: "Back",
    ...
    voiceImport: "Import",
    voiceChange: "Change",
    voiceTooLarge: "Audio too large (max 10 MB)",
    voiceUnsupported: "Audio not available on this device",
    myAlerts: "My alerts",
    addMedia: "Photo",
    mediaHint: "4 photos · audio 10 MB",
  ...
  ln: {
    ...
    sos: "SOS",
    sosHint: "Mpasi",
    line: "Ngemba IA azongisa nzela - moto akoyeba",
    powered: "Ngemba IA",
    aiListening: "Ngemba IA",
    polish: "Klarifi",
    polishing: "Kokanga...",
    ...
    installLater: "Simasi",
    orientationTitle: "Orientation Ngemba IA",
    polishUnavailable: "Klarifi ezali te - mesaje ekomeli ndenge ezali.",
    mediaOnlyAlert: "Alerte ya audio/photo - Ngemba IA azongisa, moto akotanga.",
    back: "Kembali",
    ...
    voice: "Audio",
    voiceRecord: "Lobela",
    voiceListening: "Ezali kokanga...",
    voiceImport: "Kotisa",
    voiceChange: "Bongola",
    voiceTooLarge: "Audio eza monene mingi (max 10 Mo)",
    voiceUnsupported: "Audio eza te na nzete oyo",
    myAlerts: "Nani na ngai",
    addMedia: "Foto",
    mediaHint: "4 foto · audio 10 Mo",
  ...
  sw: {
    ...
    sos: "SOS",
    sosHint: "Hatari",
    line: "Ngemba IA inaongoza - binadamu anajibu",
    powered: "Ngemba IA",
    aiListening: "Ngemba IA",
    polish: "Clarify",
    polishing: "Ufafanuzi...",
    ...
    orientationTitle: "Orientation Ngemba IA",
    polishUnavailable: "Ufafanuzi haipatikani - ujumbe unatumwa kama ulivyo.",
    mediaOnlyAlert: "Tahadhari ya media - Ngemba IA inaongoza, binadamu anasoma.",
    back: "Rudi",
    ...
    voice: "Audio",
    voiceRecord: "Sema",
    voiceListening: "Inarekodi...",
    voiceImport: "Pakia",
    voiceChange: "Badilisha",
    voiceTooLarge: "Sauti ni kubwa sana (max 10 MB)",
    voiceUnsupported: "Sauti haipatikani kwenye kifaa hiki",
    myAlerts: "Tahadhari zangu",
    addMedia: "Picha",
    mediaHint: "Picha 4 · audio 10 MB",
  ...
  lua: {
    ...
    sos: "SOS",
    sosHint: "Mpasi",
    line: "Ngemba IA - muntu udi ukumbusha",
    powered: "Ngemba IA",
    aiListening: "Ngemba IA",
    polish: "Klarifi",
    polishing: "Kokanga...",
    ...
    installLater: "Kala",
    orientationTitle: "Orientation Ngemba IA",
    polishUnavailable: "Klarifi kayi - mukanda udi utuma.",
    mediaOnlyAlert: "Alerte ya audio/photo - Ngemba IA, muntu udi umona.",
    back: "Tshienda",
    ...
    myAlerts: "Nani na ngai",
    addMedia: "Sefoto",
    mediaHint: "Mifoto 4 · audio 10 Mo",
