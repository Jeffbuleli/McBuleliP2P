...
const baseFr: Copy = {
  ...
  voiceUnsupported: "Format audio non supporté",
...
export const messages: Record<Locale, Copy> = {
  ...
  en: {
    ...
    voiceUnsupported: "Unsupported audio format",
    myAlerts: "My alerts",
    addMedia: "Photo",
  ...
  ln: {
    ...
    voiceUnsupported: "Format ya audio eza te",
  ...
  sw: {
    ...
    voiceUnsupported: "Muundo wa sauti hauungwi mkono",
