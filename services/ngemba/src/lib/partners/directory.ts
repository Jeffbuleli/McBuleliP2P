...
const SEED_PARTNERS: PartnerOrg[] = [
  ...
  },
  {
    ...
    coverageProvinceIds: ["sud-kivu"],
    coverageCommunes: ["Bukavu", "Uvira", "Baraka", "Ibanda", "Kadutu", "Bagira"],
    nationalFallback: false,
    active: true,
    contactHint: "Josué Assani · blocamanirdc@gmail.com · +243 996 839 254",
    tokenEnv: "NGEMBA_OPS_TOKEN_NGO_BCA",
    slaMinutesCritical: 8,
  },
  {
